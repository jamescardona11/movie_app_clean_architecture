...
class BubblePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final animationProgress = bubbleRadius / maxBubbleRadius;
    final double strokeWidth = bubbleRadius < maxBubbleRadius * 0.5 ? bubbleRadius : maxBubbleRadius - bubbleRadius;
